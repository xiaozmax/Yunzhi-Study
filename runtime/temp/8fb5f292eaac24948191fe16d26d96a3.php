<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:90:"/www/wwwroot/view.yunzhixinxi.com_18001/public/../application/index/view/user/profile.html";i:1721526003;s:82:"/www/wwwroot/view.yunzhixinxi.com_18001/application/index/view/layout/default.html";i:1689043529;s:79:"/www/wwwroot/view.yunzhixinxi.com_18001/application/index/view/common/meta.html";i:1710566795;s:82:"/www/wwwroot/view.yunzhixinxi.com_18001/application/index/view/common/sidenav.html";i:1716984943;s:81:"/www/wwwroot/view.yunzhixinxi.com_18001/application/index/view/common/script.html";i:1710516990;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <form id="profile-form" class="form-horizontal" role="form" data-toggle="validator" method="POST" action="<?php echo url('api/user/profile'); ?>">
                        ...
                        <div class="form-group">
                            <label class="control-label col-xs-12 col-sm-2"><!--<?php echo __('Nickname'); ?>:-->姓名</label>
                            <div class="col-xs-12 col-sm-4">
                        ...
                        <div class="form-group normal-footer">
                            <label class="control-label col-xs-12 col-sm-2"></label>
                            <div class="col-xs-12 col-sm-8">
                                <button1 class="btn btn-primary btn-embossed" onclick='location.href=("/index/user/changepwd.html")'>点击进行密码修改</button1>
                            </div>
                        </div>
                        <div class="form-group normal-footer">
                            <label class="control-label col-xs-12 col-sm-2"></label>
