 ...
 * @icon fa fa-circle-o
 */
class Studytask extends Backend
{
    /**
     * Studytask模型对象
     *
     * @var \app\admin\model\Studytask
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\Studytask();
    }
    ...
    public function index()
    {
        ...
        // 构建查询
        $query = Db::name("studytask") // 替换 'your_table_name' 为你的表名
            ->alias("t")
            ->join("user_group u", "t.class_id = u.id") // 关联 user_group 表
